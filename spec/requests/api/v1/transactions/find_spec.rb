...
describe 'Transaction Find API' do
  it 'finds a transaction by any associated attributes' do
    ...
    cc_number = transaction.credit_cart_number

    get "/api/v1/transactions/find?credit_cart_number=#{cc_number}"
  ...
  it 'finds all transactions by any associated attributes' do
    ...
    transaction_3 = create(:transaction, credit_cart_number: "4580251236515201")
    cc_number = transaction_1.credit_cart_number

    get "/api/v1/transactions/find_all?credit_cart_number=#{cc_number}"
